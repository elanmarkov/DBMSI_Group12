...
public class Tuple implements GlobalConst {
	...
	public Descriptor getDescFld(int fldNo) throws IOException, FieldNumberOutOfBoundException {
		Descriptor dVal;
		if ((fldNo > 0) && (fldNo <= fldCnt)) {
	...
	public Tuple setDescFld(int fldNo, Descriptor dVal) throws IOException, FieldNumberOutOfBoundException {
		if ((fldNo > 0) && (fldNo <= fldCnt)) {
