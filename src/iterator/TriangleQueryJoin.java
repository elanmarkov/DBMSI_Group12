...
public class TriangleQueryJoin extends Iterator{
	private static boolean OK = true;
	private static boolean FAIL = false;
	private  CondExpr  OutputFilter[];
	private NestedLoopsJoins sm;

	public TriangleQueryJoin(String label) {
	...
	public TriangleQueryJoin(CondExpr[] expr) {
		OutputFilter = expr;
		performSortMergeJoin();
	}
	...
	public void performSortMergeJoin() {
		...
		y.set(-1,-1,-1,-1,-1);
		try {
			sm = new NestedLoopsJoins (E2types, 8, E2sizes,
					E1types, 8, E1sizes,
					200,
					am, "GraphDBEDGEHEAP",
					OutputFilter, null, proj_list, 4);
		}
		catch (Exception e) {
